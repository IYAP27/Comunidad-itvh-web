...
import * as MarketplaceFeed from './marketplace-feed.js?v=1.18.6';
import * as MarketplacePublicar from './marketplace-publicar.js?v=1.18.6';
import * as MarketplaceMiNegocio from './marketplace-mi-negocio.js?v=1.18.6';
