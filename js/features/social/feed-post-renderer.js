  ...
  return `
    <article class="post-card" data-post-id="${escapeAttr(post.id)}">
      <header class="post-header">
        ...
        ` : `
          <button type="button" class="post-reportar-header" data-accion="reportar" aria-label="Reportar publicación" title="Reportar publicación">
            <span aria-hidden="true">🚩</span><span class="post-reportar-header-texto">Reportar</span>
          </button>
        `}
      </header>
